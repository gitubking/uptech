...
const NAV_ITEMS = [
  ...
  { label: 'Formations', href: '/courses', icon: BookOpen, roles: ['super_admin', 'directeur', 'responsable_pedagogique'] },
  ...
  { label: 'Comptabilité', href: '/teachers/paiements', icon: CreditCard, roles: ['enseignant'] },
